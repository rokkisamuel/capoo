...
<html lang="en">
  ...
  <body id="page-top"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top" id="mainNav">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto-left">
                ...
                <a class="nav-link text-white" href="index.php">Admin<span class="sr-only">(current)</span></a>
                </li>
            </ul>
            ...
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="lagu.php">
                        <i class="fas fa-user mr-2"></i>Daftar Lagu</a><hr class="bg-secondary">
                </li>
    ...
    <div class="col-md-10 p-5 pt-2">
            ...
            <a href="tambah_admin.php" class="btn btn-danger mb-2"> <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA ADMIN</a>
            <a href="laporan_admin.php" class="btn btn-light mb-2"> <i class="fas fa-print mr-2"></i>CETAK DATA</a>
                    ...
                    while($data = mysqli_fetch_array($sql)) {
                        ...
                        <tr>
                            ...
                            <td><i class="fas fa-edit bg-success p-2 text-white rounded">
                                    <a href="ubah_admin.php?id_admin=<?php echo $data['id_admin'];?>" class="text-white">
                                        Edit</a></i>
                                <i class="fas fa-trash-alt bg-danger p-2 text-white rounded">
                                    <a href="hapus_admin.php?id_admin=<?php echo $data['id_admin'];?>" class="text-white">
                                    Delete</a></i>
                            </td>
                        </tr>
                    <?php
