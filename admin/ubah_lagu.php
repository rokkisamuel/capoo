<?php  
    ...
    $idlagu = $_GET['idlagu']; 
    $result = mysqli_query($koneksi, "SELECT * FROM lagu WHERE idlagu='$idlagu'"); 
        while($user_data = mysqli_fetch_array($result)) {
            $judul = $user_data['judul']; 
            $penyanyi = $user_data['penyanyi']; 
...
<html lang="en">
  ...
  <body id="page-top"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top" id="mainNav">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto-left">
                ...
                <a class="nav-link text-white" href="index.php">Lagu<span class="sr-only">(current)</span></a>
                </li>
            </ul>
    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="lagu.php">
    ...
    <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-music mr-2"></i> Ubah Data Lagu</h3><hr>
            <form action="update_lagu.php" method="post"> 
                <div class="form-row"> 
                    <div class="form-group col-md-4"> 
                        <h6>ID Lagu</h6> 
                        <input type="text" name="idlagu" class="form-control" id="idlagu" value=<?php echo $idlagu;?>> 
                    </div> 
                </div> 
                <div class="form-row"> 
                ...
                <div class="form-row"> 
                    <div class="form-group col-md-6"> 
                        <h6>Penyanyi</h6> 
                        <input type="text" name="penyanyi" class="form-control" id="penyanyi" value=<?php echo $penyanyi;?>>     
                    </div> 
                </div> 
                <div class="form-row"> 
                    <div class="form-group col-md-6"> 
                        <h6>Negara</h6> 
                        <input type="text" name="negara" class="form-control" id="negara" value=<?php echo $negara;?>>     
                    </div> 
                </div> 
